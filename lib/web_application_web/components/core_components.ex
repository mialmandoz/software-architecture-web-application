defmodule WebApplicationWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WebApplicationWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WebApplicationWeb.Gettext, "errors", msg, opts)
    end
  end
